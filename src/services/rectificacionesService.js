...
export const rectificacionesService = {
    ...
    rectificarVenta: async ({ id_venta, nuevos_detalles, metodo_pago, motivo }) => {
        const response = await api.post('/rectificaciones/ventas', { id_venta, nuevos_detalles, metodo_pago, motivo });
