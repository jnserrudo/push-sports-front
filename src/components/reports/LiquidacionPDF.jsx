...
const LiquidacionPDF = ({ row }) => {
  ...
  const colCodigo = { width: '12%', justifyContent: 'center' };
  const colInfo = { width: '38%', paddingRight: 6 };
  const colCant = { width: '10%', alignItems: 'center' };
  const colCobrado = { width: '15%', alignItems: 'flex-end' };
  const colPush = { width: '15%', alignItems: 'flex-end' };
  const colTotal = { width: '10%', alignItems: 'flex-end' };
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerBand}>
          <View style={styles.brandBlock}>
            ...
            <Text style={styles.logoSub}>RECIBO OFICIAL DE LIQUIDACIÓN</Text>
          </View>
        ...
        <View style={styles.infoStrip}>
          <Text style={styles.infoStripText}>Detalle de liquidación de ventas</Text>
        ...
        <View style={styles.metricBar}>
          ...
          <View style={[styles.metricCell, { borderRightWidth: 0 }]}>
            <Text style={styles.metricLabel}>Neto Liquidado</Text>
            <Text style={styles.metricValue}>{formatPrice(row.total_ventas_netas)}</Text>
            <Text style={styles.metricSub}>a favor de la empresa</Text>
          </View>
        </View>
        ...
        <View style={styles.tableContainer}>
          <View style={styles.tableHeader}>
            ...
            <View style={colPush}><Text style={styles.headerText}>P. Push</Text></View>
            <View style={colTotal}><Text style={styles.headerText}>Total Neto</Text></View>
          </View>
        ...
        <View style={styles.totalContainer}>
          {row.desglose_metodo_pago && Object.entries(row.desglose_metodo_pago).map(([metodo, total], i) => (
          ...
          <View style={styles.grandTotalRow}>
            <Text style={styles.grandTotalLabel}>Neto Liquidado</Text>
